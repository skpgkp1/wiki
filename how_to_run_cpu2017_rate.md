...
Reading file manifests... read 32125 entries from 2 files in 0.07s (430018 files/s)
...
Compiling Binaries
  Building 600.perlbench_s base 2018083121798: (build_base_2018083121798.0000) [2018-08-31 13:36:34]
  Building 602.gcc_s base 2018083121798: (build_base_2018083121798.0000) [2018-08-31 13:36:50]
```
...
export thread=$(echo ${corecount}/2 | bc)
export NUM="3"
export bits="64"
export GCC_DIR=/local/foo/comp/gcc
export BASEOPT="-march=native -mfpmath=sse -O2" # Compiler option applied to all benchmarks.
...
runcpu  -a validate --loose -I -i ref -o asc -c spec2017.cfg --label `date +%Y%m%d$$` -T base -n $NUM  --thread $thread -I specspeed
```
